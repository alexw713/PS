...
export default function PerformerCard({ slug, stageName, nationality, bio, tags }: Props) {
  return (
    <Link
    ...
    >
      <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-pink-500/80 to-purple-600/80 text-lg font-bold text-white">
        {stageName.slice(0, 1)}
      </div>
